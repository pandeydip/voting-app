        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    ...
                    esse inventore magni nostrum, perspiciatis praesentium quia reiciendis rem sed veniam?
                    Dignissimos, illo inventore laboriosam nesciunt nihil odio quis sapiente voluptates.
                </div>
                <div class="flex item-center justify-between mt-6">
                    ...
                    <div class="flex item-center space-x-2">
                        ...
                        <button
                            ...
                            {{--                                <li><a href=""--}}
                            {{--                                       class="hover:bg-gray-100 transition block duration-500 ease-in px-5 py-3">Mark as--}}
                            {{--                                        spam</a></li>--}}
                            {{--                                <li><a href=""--}}
    ...
    <div class="buttons-container">
        <div class="flex items-center justify-between mt-6">
            <div class="flex items-center justify-between space-x-4 ml-6">
                <div class="relative">
                    <button type="button"
                            class="flex items-center text-white bg-blue justify-center w-32 h-11 text-sm font-semibold rounded-xl border border-gray-200 hover:bg-blue-hover transition duration-200 ease-in px-6 py-3">
                    ...
                    <div
                        ...
                        <form action="#" class="space-y-4 px-4 py-6">
                            <div>
                                <textarea class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2" placeholder="Go ahead, don't be shy. Share your thoughts..." name="post_comment" id="post_comment" cols="30" rows="4"></textarea>
                            </div>
                            <div class="flex items-center space-x-3">
                                ...
                                <button type="button"
                                        class="flex items-center bg-gray-200 justify-center w-32 h-11 text-sm font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-200 ease-in px-6 py-3">
                ...
                <div class="relative">
                    <button type="button"
                            class="flex items-center bg-gray-200 justify-center w-34 h-11 text-sm font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-200 ease-in px-6 py-3">
                        <span>Set Status</span>
                        <svg class="text-gray-600 w-4 h-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex items-center space-x-3">
                ...
                <button type="button"
                        class="flex items-center uppercase bg-gray-200 justify-center w-34 h-11 text-xs font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-200 ease-in px-6 py-3">
                    <span>Vote</span>
                </button>
            </div>
        </div>
